...
class SuggestionsWidgetAsset extends AssetBundle
{
    ...
    public $js = ["https://cdn.jsdelivr.net/npm/suggestions-jquery@19.8.0/dist/js/jquery.suggestions.min.js"];

    public $css = ["https://cdn.jsdelivr.net/npm/suggestions-jquery@19.8.0/dist/css/suggestions.min.css"];
}
